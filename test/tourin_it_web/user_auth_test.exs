defmodule TourinItWeb.UserAuthTest do
  use TourinItWeb.ConnCase

  alias Phoenix.LiveView
  alias TourinIt.Accounts
  alias TourinItWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TourinItWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TourinItWeb.Endpoint.subscribe(live_socket_id)
