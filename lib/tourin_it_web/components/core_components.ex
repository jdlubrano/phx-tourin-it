defmodule TourinItWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TourinItWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TourinItWeb.Gettext, "errors", msg, opts)
    end
  end
